...
HD_PWD='D:/lab6_2_Tues/lab6_1.runs/mb_block_axi_gpio_1_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_axi_gpio_1_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_axi_gpio_1_10.tcl
